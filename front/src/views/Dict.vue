...
<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm title="Confirm delete?" @confirm="confirmDelBatch" v-if="auths.includes('dict.deleteBatch')">
        <template #reference>
      ...
      <el-table :data="state.tableData" stripe border  @selection-change="handleSelectionChange">
        ...
        <el-table-column label="operate" width="180">
          <template #default="scope">
            ...
            <el-popconfirm title="Confirm delete?" @confirm="del(scope.row.id)" v-if="auths.includes('dict.delete')">
              <template #reference>
