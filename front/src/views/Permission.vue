...
<!--      <el-popconfirm title="Confirm delete?" @confirm="confirmDelBatch" v-if="auths.includes('permission.deleteBatch')">-->
<!--        <template #reference>-->
      ...
      <el-table :data="state.tableData" stripe border row-key="id"  @selection-change="handleSelectionChange">
        ...
        <el-table-column label="operate" width="180">
          <template #default="scope">
            ...
            <el-popconfirm title="Confirm delete?" @confirm="del(scope.row.id)" v-if="auths.includes('permission.delete')">
              <template #reference>
