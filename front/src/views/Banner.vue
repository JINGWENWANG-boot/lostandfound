...
<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm title="Confirm delete?" @confirm="confirmDelBatch" v-if="auths.includes('banner.deleteBatch')">
        <template #reference>
    ...
    <div style="margin: 10px 0">
      ...
      <el-table-column prop="index_radio" label="status"></el-table-column>
        ...
        <el-table-column label="operate" width="220">
          <template #default="scope">
            ...
            <el-popconfirm title="Confirm delete?" @confirm="del(scope.row.id)" v-if="auths.includes('banner.delete')">
              <template #reference>
    ...
    <el-dialog v-model="dialogFormVisible" title="Slideshow information" width="40%">
      <el-form ref="ruleFormRef" :rules="rules" :model="state.form" label-width="80px" style="padding: 0 20px" status-icon>
        ...
        <el-form-item prop="url" label="link">
          <el-input v-model="state.form.url" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="indexRadio" label="status">
