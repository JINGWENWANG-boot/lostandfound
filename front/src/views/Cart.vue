...
<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm title="Confirm delete?" @confirm="confirmDelBatch" v-if="auths.includes('cart.deleteBatch')">
        <template #reference>
      ...
      <el-table-column prop="goodid" label="Item Number"></el-table-column>
        ...
        <el-table-column label="operate" width="220">
          <template #default="scope">
            ...
            <el-popconfirm title="Confirm delete?" @confirm="del(scope.row.id)" v-if="auths.includes('cart.delete')">
              <template #reference>
...
.el-dialog {
  ...
  padding: 20px; /* Set the dialog box's padding */
