...
<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm title="Confirm delete?" @confirm="confirmDelBatch" v-if="auths.includes('category.deleteBatch')">
        <template #reference>
      ...
      <el-table-column prop="name" label="Category Name"></el-table-column>
        ...
        <el-table-column label="operate" width="220">
          <template #default="scope">
            ...
            <el-popconfirm title="Confirm delete?" @confirm="del(scope.row.id)" v-if="auths.includes('category.delete')">
              <template #reference>
