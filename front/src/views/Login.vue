...
<template>
  <div class="wrapper">
    <div style="margin: 150px auto; background-color: #FF9900; width: 400px; height: 330px; padding: 20px; border-radius: 10px">
      ...
      >
        ...
        <div style="text-align: center;">
          <a style="text-decoration: none; color: #ffffff;margin-left: 20px;" href="/front/home">Front desk</a>
        </div>
    </div>
