...
<template>
  <div>
      ...
      <div style="display: flex">
        ...
        <div style="flex: 1; display: flex">
          ...
          <div style="width: 500px; text-align: right; padding-right: 20px">
            <span style="margin-right: 5px; color: #FFFFFF">Welcome back,{{ user.name }}</span>
            <a href="javascript:void(0)" @click="router.push('/front/home')" class="infoCls">Front desk</a>
            <a href="javascript:void(0)" @click="router.push('/person')" class="infoCls">Personal</a>
            <a href="javascript:void(0)" @click="router.push('/password')" class="infoCls">Change</a>
    ...
    <div style="display: flex;">
      <div style="width: 230px; min-height: calc(100vh - 60px); border-right: 1px solid #ccc;background-color: #FF9900">
        <el-menu
